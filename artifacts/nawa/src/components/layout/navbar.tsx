          ...
          <div className="container mx-auto px-4 md:px-6 h-9 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <a href="https://wa.me/966500073509" target="_blank" rel="noreferrer"
                ...
                <span dir="ltr">+966 50 007 3509</span>
              </a>
            ...
            <div className="flex items-center gap-2">
              <SocialLink href="https://instagram.com/nawainv">
              ...
              <SocialLink href="https://x.com/nawainv">
              ...
              <SocialLink href="https://linkedin.com/company/nawainv">
