...
export default function Terms() {
  ...
  useEffect(() => {
    document.title = language === "ar" ? "الشروط والأحكام | نوى العقارية" : "Terms & Conditions | Nawa Real Estate Platform";
  }, [language]);
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground">
          {language === "ar" ? (
            <>
              ...
              <h2>1. قبول الشروط</h2>
              <p>بدخولك أو استخدامك لموقع نوى العقارية، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على هذه الشروط، يرجى عدم استخدام الموقع.</p>
              
              <h2>2. استخدام الموقع</h2>
              <p>يجب استخدام الموقع لأغراض قانونية فقط وبطريقة لا تنتهك حقوق الآخرين أو تقيد أو تمنع استخدامهم للموقع. يمنع منعاً باتاً أي استخدام غير مصرح به قد يؤدي إلى مطالبة بالتعويض عن الأضرار أو يشكل جريمة جنائية.</p>
              
              <h2>3. الملكية الفكرية</h2>
              <p>جميع المحتويات على هذه الموقع، بما في ذلك النصوص والتصميمات والرسومات والشعارات، هي ملك لنوى العقارية ومحمية بقوانين حقوق النشر. لا يجوز إعادة إنتاج أو توزيع أو استخدام أي من هذه المحتويات دون إذن كتابي مسبق.</p>
              
              <h2>4. إخلاء المسؤولية</h2>
              <p>يتم توفير المعلومات على هذه الموقع "كما هي" دون أي ضمانات من أي نوع. لا نتحمل المسؤولية عن أي أخطاء أو سهو في المحتوى، ولا عن أي خسائر قد تنشأ عن الاعتماد على المعلومات المقدمة.</p>
            </>
          ) : (
            <>
